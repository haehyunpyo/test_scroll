        ...
        <header class="bg-dark py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="text-center text-white">
                    <h1 class="display-4 fw-bolder">경매물품</h1>
        ...
        <footer class="py-5" id="footer">
            <div class="container">
	            <ul class="menubar">
	            	...
	            	<li><i class="xi-comment xi-2x"></i><div id="menu">게시판</div></li>
	            	<li><img src="../img/경매.png" alt="" width="55%"><div id="menu">경매</div></li>
	            	<li><i class="xi-message xi-2x"></i><div id="menu">채팅</div></li>
	            	<li><i class="xi-profile xi-2x"></i><div id="menu">나의셀라스</div></li>
	            </ul>
            </div>
        </footer>
        <!-- Bootstrap core JS-->
